...
# ═══════════════════════════════════════════════════════════════════════════════
# Banner — Arch logo (left) + FIGlet "small" text (right)
# ═══════════════════════════════════════════════════════════════════════════════
...
echo ""
printf '%s\n' \
    "   ${_BC}              ${_BR}   ${_BB}   _          _      _    _${_BR}" \
    "   ${_BC}      /\\      ${_BR}   ${_BB}  /_\\  _ _ __| |_   | |  (_)_ _ _  ___ __${_BR}" \
    "   ${_BC}     /  \\     ${_BR}   ${_BB} / _ \\| '_/ _| ' \\  | |__| | ' \\ || \\ \\ /${_BR}" \
    "   ${_BC}    /    \\    ${_BR}   ${_BB}/_/ \\_\\_| \\__|_||_| |____|_|_||_\\_,_/_\\_\\${_BR}" \
    "   ${_BC}   /      \\   ${_BR}   ${_BM} ___           _      _${_BR}" \
    "   ${_BC}  /   ,,   \\  ${_BR}   ${_BM}| _ ) ___  ___| |_ __| |_ _ _ __ _ _ __${_BR}" \
    "   ${_BC} /   |  |   \\ ${_BR}   ${_BM}| _ \\/ _ \\/ _ \\  _(_-<  _| '_/ _\` | '_ \\${_BR}" \
    "   ${_BC}/_-''    ''-_\\${_BR}   ${_BM}|___/\\___/\\___/\\__/__/\\__|_| \\__,_| .__/${_BR}" \
    "   ${_BC}              ${_BR}   ${_BM}                                  |_|${_BR}" \
    "" \
    "   ${_BD}Archinstall 4.1 Configuration Generator${_BR}"
echo ""
