...
TRANSLATIONS: dict[str, dict[str, str]] = {
    'en': {
        ...
        'dms.installing_pacman': 'Installing DMS system packages...',
        'dms.building_aur': 'Building AUR package: %s',
        'dms.downloading_templates': 'Downloading DMS configuration templates...',
        'dms.deploying_config': 'Deploying DMS configuration for %s...',
        'dms.setup_systemd': 'Setting up DMS systemd user service...',
        'dms.setup_greetd': 'Configuring greetd display manager...',
    ...
    'zh': {
        ...
        'confirm.terminal': '终端',
        'dms.installing_pacman': '正在安装 DMS 系统包...',
        'dms.building_aur': '正在构建 AUR 包：%s',
        'dms.downloading_templates': '正在下载 DMS 配置模板...',
        'dms.deploying_config': '正在部署 %s 的 DMS 配置...',
        'dms.setup_systemd': '正在配置 DMS systemd 用户服务...',
        'dms.setup_greetd': '正在配置 greetd 显示管理器...',
    ...
    'ja': {
        ...
        'dms.installing_pacman': 'DMS システムパッケージをインストール中...',
        'dms.building_aur': 'AUR パッケージをビルド中：%s',
        'dms.downloading_templates': 'DMS 設定テンプレートをダウンロード中...',
        'dms.deploying_config': '%s の DMS 設定をデプロイ中...',
        'dms.setup_systemd': 'DMS systemd ユーザーサービスを設定中...',
        'dms.setup_greetd': 'greetd ディスプレイマネージャーを設定中...',
