...
TRANSLATIONS: dict[str, dict[str, str]] = {
    'en': {
        ...
        'dms.greeter_configuring': 'Configuring and synchronizing DMS greeter...',
        'dms.greeter_bootstrap_written': 'Wrote bootstrap greetd config to %s',
        'dms.greeter_home_failed': 'Failed to set greeter home (exit %d)',
        'dms.greeter_home_create_failed': 'Failed to create greeter home (exit %d)',
        'dms.greeter_cache_failed': 'Failed to create greeter cache (exit %d)',
        'dms.greeter_group_failed': 'Failed to add desktop user to greeter group (exit %d)',
        'dms.greeter_sync_failed': 'DMS greeter sync failed (exit %d); bootstrap config remains valid',
        'dms.greeter_complete': 'DMS greeter configured and synchronized successfully',
        'dms.greeter_fallback': 'Greeter sync failed; preserving the valid bootstrap config',
        'dms.extras_installing': 'Installing DMS runtime and extra packages...',
        'dms.extras_complete': 'DMS runtime and extra packages installed',
        'dms.extras_failed': 'DMS runtime and extra package installation failed (exit %d)',
        'dms.install_incomplete': 'DMS desktop setup did not complete',
        # -- DMS Manual --
        ...
        'dms_manual.install_incomplete': 'DMS manual desktop setup did not complete',
        # -- Exo desktop --
    ...
    'zh': {
        ...
        'dms.greeter_configuring': '正在配置并同步 DMS 登录界面...',
        'dms.greeter_bootstrap_written': '已将 greetd 引导配置写入 %s',
        'dms.greeter_home_failed': '设置 greeter 主目录失败（退出码 %d）',
        'dms.greeter_home_create_failed': '创建 greeter 主目录失败（退出码 %d）',
        'dms.greeter_cache_failed': '创建 greeter 缓存目录失败（退出码 %d）',
        'dms.greeter_group_failed': '将桌面用户加入 greeter 组失败（退出码 %d）',
        'dms.greeter_sync_failed': 'DMS 登录界面同步失败（退出码 %d）；保留有效的引导配置',
        'dms.greeter_complete': 'DMS 登录界面配置和同步完成',
        'dms.greeter_fallback': '登录界面同步失败；已保留有效的引导配置',
        'dms.extras_installing': '正在安装 DMS 运行时和额外软件包...',
        'dms.extras_complete': 'DMS 运行时和额外软件包安装完成',
        'dms.extras_failed': 'DMS 运行时和额外软件包安装失败（退出码 %d）',
        'dms.install_incomplete': 'DMS 桌面配置未能完成',
        # -- DMS 手动安装 --
        ...
        'dms_manual.install_incomplete': 'DMS 手动桌面配置未能完成',
        # -- Exo 桌面 --
        'step.desktop.exo': 'Exo（Material Design 3 + Niri）',
    ...
    'ja': {
        ...
        'dms.greeter_configuring': 'DMS greeter を設定・同期中...',
        'dms.greeter_bootstrap_written': 'greetd のブートストラップ設定を %s に書き込みました',
        'dms.greeter_home_failed': 'greeter ホームの設定に失敗しました（終了コード %d）',
        'dms.greeter_home_create_failed': 'greeter ホームの作成に失敗しました（終了コード %d）',
        'dms.greeter_cache_failed': 'greeter キャッシュの作成に失敗しました（終了コード %d）',
        'dms.greeter_group_failed': 'デスクトップユーザーの greeter グループ追加に失敗しました（終了コード %d）',
        'dms.greeter_sync_failed': 'DMS greeter の同期に失敗しました（終了コード %d）。有効なブートストラップ設定は保持されます',
        'dms.greeter_complete': 'DMS greeter の設定と同期が完了しました',
        'dms.greeter_fallback': 'greeter の同期に失敗したため、有効なブートストラップ設定を保持します',
        'dms.extras_installing': 'DMS ランタイムと追加パッケージをインストール中...',
        'dms.extras_complete': 'DMS ランタイムと追加パッケージをインストールしました',
        'dms.extras_failed': 'DMS ランタイムと追加パッケージのインストールに失敗しました（終了コード %d）',
        'dms.install_incomplete': 'DMS デスクトップのセットアップが完了しませんでした',
        # -- DMS 手動インストール --
        ...
        'dms_manual.install_incomplete': 'DMS 手動デスクトップのセットアップが完了しませんでした',
        # -- Exo デスクトップ --
        'step.desktop.exo': 'Exo（Material Design 3 + Niri）',
