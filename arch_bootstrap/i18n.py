...
TRANSLATIONS: dict[str, dict[str, str]] = {
    'en': {
        ...
        'dms_manual.installing_deps':    'Installing DMS dependencies...',
        ...
        'exo.installing_deps': 'Installing Exo dependencies...',
        ...
        'post.input_method_dicts': 'Installing prebuilt input method dictionaries ...',
        'post.input_method_dict_installed': 'Installed input method dictionary: %s',
        'post.input_method_dict_failed': 'Input method dictionary install failed for %s (exit %s), continuing',
        ...
        'post.dev_groups': 'Configuring development user groups ...',
        ...
        'summary.step.dev_groups': 'Development user groups',
    ...
    'zh': {
        ...
        'dms_manual.installing_deps':    '正在安装 DMS 依赖...',
        ...
        # -- Exo 桌面 --
        'step.desktop.exo': 'Exo（Material Design 3 + Niri）',
        'exo.installing_deps': '正在安装 Exo 依赖...',
        ...
        'post.input_method_dicts': '正在安装预构建输入法词库 ...',
        'post.input_method_dict_installed': '已安装输入法词库：%s',
        'post.input_method_dict_failed': '输入法词库 %s 安装失败（退出码 %s），继续安装',
        ...
        'summary.step.dev_groups': '开发工具用户组',
    ...
    'ja': {
        ...
        'dms_manual.installing_deps':    'DMS依存パッケージをインストール中...',
        ...
        # -- Exo デスクトップ --
        'step.desktop.exo': 'Exo（Material Design 3 + Niri）',
        'exo.installing_deps': 'Exo の依存関係をインストール中...',
        ...
        'post.input_method_dicts': 'ビルド済み入力メソッド辞書をインストール中 ...',
        'post.input_method_dict_installed': '入力メソッド辞書をインストールしました: %s',
        'post.input_method_dict_failed': '入力メソッド辞書 %s のインストールに失敗しました（終了コード %s）。続行します',
        ...
        'post.dev_groups': '開発用ユーザーグループを設定中 ...',
        ...
        'summary.step.dev_groups': '開発用ユーザーグループ',
